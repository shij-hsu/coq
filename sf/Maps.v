...
Proof. unfold t_empty. intros A x v. reflexivity. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Lemma t_update_eq : forall A (m: total_map A) x v,
  (t_update m x v) x = v.
Proof. intros A m x v. unfold t_update. rewrite <-beq_id_refl. reflexivity. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Proof. intros X v x1 x2 m H. unfold t_update. rewrite (false_beq_id x1 x2 H). reflexivity. Qed.
(* FILL IN HERE *) 
(** [] *)
...
Lemma t_update_shadow : forall A (m: total_map A) v1 v2 x,
  ...
  = t_update m x v2.
Proof. intros A m v1 v2 x. unfold t_update.
   apply functional_extensionality. intros.
   destruct (beq_id x x0) eqn:E1.
   - reflexivity.
   - reflexivity. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Proof. intros x y. apply iff_reflect. split.
   - intros. apply beq_id_true_iff. apply H.
   - intros. apply beq_id_true_iff. apply H. Qed.
(* FILL IN HERE *)
(** [] *)
...
Theorem t_update_same : forall X x (m : total_map X),
  t_update m x (m x) = m.
Proof. intros X x m. unfold t_update. apply functional_extensionality.
   intros. destruct (beq_id x x0) eqn:E1.
   - rewrite beq_id_true_iff in E1. rewrite E1. reflexivity.
   - reflexivity. Qed.
 (* FILL IN HERE *)
(** [] *)
...
Proof. intros X v1 v2 x1 x2 m H. unfold t_update. apply functional_extensionality. intros. destruct (beq_id x1 x) eqn:E1.
   - destruct (beq_id x2 x) eqn:E2.
     + destruct (beq_id_true_iff x1 x). destruct (beq_id_true_iff x2 x).
       rewrite (H0 E1) in H. rewrite (H2 E2) in H. SearchAbout "beq".
