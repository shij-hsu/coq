...
Theorem rev_exercise1 : forall (l l' : list nat),
     l = rev l' ->
     l' = rev l.
Proof. intros. rewrite H. rewrite rev_involutive. reflexivity. Qed.
(** [] *)
...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = m ->
     (n + p) = (minustwo o).
Proof. intros. apply trans_eq with m.
...
Example inversion_ex3 : forall (X : Type) (x y z : X) (l j : list X),
  ...
  y :: l = x :: j ->
  x = y.
Proof. intros. inversion H. inversion H0. symmetry. apply H2. Qed.
(** [] *)
