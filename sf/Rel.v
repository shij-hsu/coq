...
Proof.
  ...
  apply (le_trans (S n) m (S m)). apply Hnm. apply le_S. apply le_n.
  apply (le_trans (S n) m' (S m')). apply IHHm'o. apply le_S. apply le_n. Qed.
    (* FILL IN HERE *)
(** [] *)
...
Proof.
  ...
  intros n m o Hnm Hmo.
  induction o as [| o'].
  inversion Hmo. apply (le_trans (S n) (S m) (S o')). apply (le_trans (S n) m (S m)).
  apply Hnm. apply le_S. apply le_n. apply Hmo. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Proof. intros n m H. inversion H.
   - apply le_n.
   - apply (le_trans n (S n)). apply le_S.
     apply le_n. apply H1. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Theorem le_Sn_n : forall n,
  ~ (S n <= n).
Proof. intros. unfold not. intros. induction n.
   - inversion H.
   - apply (IHn (le_S_n (S n) n H)). Qed.
  (* FILL IN HERE *)
(** [] *)
...
Theorem le_not_symmetric :
  ~ (symmetric le).
Proof. unfold not. unfold symmetric. intros.
   assert (0<=1->1<=0). apply H. assert (0<=1). auto. assert (1<=0). apply (H0 H1). inversion H2. Qed.
(* FILL IN HERE *)
(** [] *)
...
Theorem le_antisymmetric :
  antisymmetric le.
Proof. unfold antisymmetric. intros a. induction a.
   - intros. destruct b. reflexivity. inversion H0.
   - intros. destruct b. inversion H. SearchAbout "Sn".
     rewrite (IHa b (Sn_le_Sm__n_le_m a b H) (Sn_le_Sm__n_le_m b a H0)). reflexivity. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Theorem le_step : forall n m p,
  ...
  m <= S p ->
  n <= p.
Proof. unfold lt. intros. SearchAbout "eq". apply le_S_n. apply (le_trans (S n) m (S p)). apply H. apply H0. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Proof. intros. induction H.
   - apply H0.
   - apply rt1n_trans with y. apply H. apply IHclos_refl_trans_1n. apply H0. Qed.
  (* FILL IN HERE *)
(** [] *)
...
Proof. intros. split.
   ...
   - intros. induction H. apply rt_refl. apply rt_trans with y. apply rt_step. apply H.
     apply IHclos_refl_trans_1n. Qed.
  (* FILL IN HERE *)
(** [] *)
