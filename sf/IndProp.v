...
Proof. (*intros n E. induction E as [|n' E'].
       - exists 0. reflexivity.
       - destruct IHE' as [k']. exists (S k').
...
Proof. intros n m Hn Hm. induction Hn.
       - simpl. apply Hm.
...
Proof. intros n.
       split. intros H1.
       - induction H1. apply ev_0. apply ev_SS. apply ev_0.
         assert (Myev_sum:forall  n m, ev n->ev m->ev (n+m)).
         { intros. induction H. simpl. apply H0. simpl. apply ev_SS. apply IHev. }
         apply Myev_sum. apply IHev'1. apply IHev'2.
       - intros H1. induction H1. apply ev'_0. assert ((S (S n))=2+n).
         { simpl. reflexivity. } rewrite H. apply ev'_sum. apply ev'_2. apply IHev. Qed.
(** [] *)
...
Proof. intros n m Hnm Hn. induction Hn.
       ...
       - apply IHHn. simpl in Hnm. inversion Hnm.
         + apply H0. Qed.
  (* FILL IN HERE *)
(** [] *)
