  ...
  empty |-
    (tapp (tabs a (TRCons i1 (TArrow A A)
            ...
            (trcons i2 (tabs a B (tvar a))
             trnil))) \in
    (TArrow B B).
Proof. eapply T_App. eapply T_Abs. apply wfTRCons.
   apply wfTArrow. apply wfTBase. apply wfTBase.
   apply wfTRCons. apply wfTArrow. apply wfTBase. apply wfTBase.
   apply wfTRNil. apply RTnil.
   apply RTcons. eapply T_Proj.  apply T_Var. unfold update, t_update. simpl. reflexivity.
   apply wfTRCons. apply wfTArrow. apply wfTBase. apply wfTBase.
   apply wfTRCons. apply wfTArrow. apply wfTBase. apply wfTBase.
   apply wfTRNil. apply RTnil. apply RTcons.
   unfold Tlookup. simpl. reflexivity.
   apply T_RCons. apply T_Abs. apply wfTBase. apply T_Var.
   unfold update, t_update. simpl. reflexivity.
   apply wfTBase. apply T_RCons. apply T_Abs. apply wfTBase.
   apply T_Var. unfold update, t_update. reflexivity.
   apply wfTBase. apply T_RNil. apply RTnil. apply rtnil.
   apply RTcons. apply rtcons. Qed.
  (* FILL IN HERE *) 
...
Example typing_nonexample :
  ~ exists T,
      (update empty a (TRCons i2 (TArrow A A)
               ...
               T.
Proof. unfold not. intros. destruct H. inversion H.
   subst. inversion H8. Qed.
  (* FILL IN HERE *)
...
Example typing_nonexample_2 : forall y,
  ~ exists T,
    (update empty y A) |-
           ...
           T.
Proof. unfold not. intros. destruct H. inversion H.
   subst. inversion H5. subst. inversion H10. subst. inversion H3.
   subst. inversion H6. subst. inversion H7. Qed.
  (* FILL IN HERE *) 
